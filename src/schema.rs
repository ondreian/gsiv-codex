...
const MIGRATIONS: &[(&str, &str)] = &[
    ...
    ("013_circuits", include_str!("../schema/013_circuits.sql")),
    (
        "014_transient_exits",
        include_str!("../schema/014_transient_exits.sql"),
    ),
    ...
    (
        "018_edge_costs",
        include_str!("../schema/018_edge_costs.sql"),
    ),
    ("019_creatures", include_str!("../schema/019_creatures.sql")),
    (
        "020_weapon_nouns",
